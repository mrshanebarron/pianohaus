<x-layouts.admin title="Add Brand">
    <div class="flex items-center gap-4 mb-6">
        ...
        <h2 class="text-xl font-display font-semibold text-ivory-100">Add Brand</h2>
    </div>

    <form method="POST" action="{{ route('admin.brands.store') }}" class="max-w-lg">
        @csrf
