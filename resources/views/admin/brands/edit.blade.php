<x-layouts.admin title="Edit {{ $brand->name }}">
    <div class="flex items-center gap-4 mb-6">
        ...
        <h2 class="text-xl font-display font-semibold text-ivory-100">Edit Brand</h2>
    </div>

    <form method="POST" action="{{ route('admin.brands.update', $brand) }}" class="max-w-lg">
        @csrf @method('PUT')
